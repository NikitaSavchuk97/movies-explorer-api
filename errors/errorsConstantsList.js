const incorrectEmailOrPasswordUser = 'Неправильные почта или пароль';
...
const notYourDeleteFilm = 'Пытаетесь удалить чужой фильм';

const incorrectDataForm = 'Некорректные данные одного из полей';
